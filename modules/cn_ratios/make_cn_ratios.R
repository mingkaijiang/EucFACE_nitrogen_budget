make_cn_ratios <- function(c_pool, n_pool, c_flux, n_flux) {
    ...
    out$soil <- as.numeric(c_pool[c_pool$terms == "Soil C Pool", 2:7]/n_pool[n_pool$terms == "Soil N Pool",
                                                                                 2:7])
    
    out$microbe <- as.numeric(c_pool[c_pool$terms == "Microbial C Pool", 2:7]/n_pool[n_pool$terms == "Microbial N Pool",
                                                                                 2:7])
