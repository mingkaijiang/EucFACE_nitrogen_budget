prepare_mip_veg_n_upt_flux <- function(nbudgetDF,
                                       ambDF,
                                       eleDF,
                                       difDF,
                                       var.list,
    ...
    myDF1$meanvalue[myDF1$Variable=="NUP"&myDF1$Group=="obs"&myDF1$Trt=="aCO2"] <- nbudgetDF$aCO2[nbudgetDF$terms=="Plant N uptake flux"]
    myDF1$meanvalue[myDF1$Variable=="NUP"&myDF1$Group=="obs"&myDF1$Trt=="eCO2"] <- nbudgetDF$eCO2[nbudgetDF$terms=="Plant N uptake flux"]
    myDF1$sdvalue[myDF1$Variable=="NUP"&myDF1$Group=="obs"&myDF1$Trt=="aCO2"] <- nbudgetDF$aCO2_sd[nbudgetDF$terms=="Plant N uptake flux"]
    myDF1$sdvalue[myDF1$Variable=="NUP"&myDF1$Group=="obs"&myDF1$Trt=="eCO2"] <- nbudgetDF$eCO2_sd[nbudgetDF$terms=="Plant N uptake flux"]
    
    
    myDF1$meanvalue[myDF1$Variable=="NMIN"&myDF1$Group=="obs"&myDF1$Trt=="aCO2"] <- nbudgetDF$aCO2[nbudgetDF$terms=="Soil N mineralization flux"]
    myDF1$meanvalue[myDF1$Variable=="NMIN"&myDF1$Group=="obs"&myDF1$Trt=="eCO2"] <- nbudgetDF$eCO2[nbudgetDF$terms=="Soil N mineralization flux"]
    myDF1$sdvalue[myDF1$Variable=="NMIN"&myDF1$Group=="obs"&myDF1$Trt=="aCO2"] <- nbudgetDF$aCO2_sd[nbudgetDF$terms=="Soil N mineralization flux"]
    myDF1$sdvalue[myDF1$Variable=="NMIN"&myDF1$Group=="obs"&myDF1$Trt=="eCO2"] <- nbudgetDF$eCO2_sd[nbudgetDF$terms=="Soil N mineralization flux"]
    ...
    nbudgetDF$diff <- with(nbudgetDF, eCO2 - aCO2)
    nbudgetDF$percent_diff <- with(nbudgetDF, (eCO2 - aCO2)/aCO2) * 100
    
    myDF2$meanvalue[myDF2$Variable=="NUP"&myDF2$Group=="obs"&myDF2$Trt=="diff"] <- nbudgetDF$diff[nbudgetDF$terms=="Plant N uptake flux"]
    myDF2$meanvalue[myDF2$Variable=="NUP"&myDF2$Group=="obs"&myDF2$Trt=="pct_diff"] <- nbudgetDF$percent_diff[nbudgetDF$terms=="Plant N uptake flux"]

    
    myDF2$meanvalue[myDF2$Variable=="NMIN"&myDF2$Group=="obs"&myDF2$Trt=="diff"] <- nbudgetDF$diff[nbudgetDF$terms=="Soil N mineralization flux"]
    myDF2$meanvalue[myDF2$Variable=="NMIN"&myDF2$Group=="obs"&myDF2$Trt=="pct_diff"] <- nbudgetDF$percent_diff[nbudgetDF$terms=="Soil N mineralization flux"]
