make_twiglitter_n_flux <- function(n_conc, litter_flux) {
    ...
    outDF$twiglitter_n_flux_mg_m2_d <- outDF$twig_flux*outDF$PercN/100
    
    outDF$Days <- as.numeric(with(outDF, End_date - Start_date))
    
    outDF <- outDF[,c("Date", "Start_date", "End_date", "Ring", "twiglitter_n_flux_mg_m2_d", "Days")]
